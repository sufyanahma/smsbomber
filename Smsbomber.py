...
W='\033[0m'
# The Credit For This Code Goes To SufyaNAhmaD And All Other Contributors Listed At https://github.com/sufyanahma/smsbomber
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To sufyanwafa1111@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By SufyaN !!                ")
        print("==================================================================")
        try:
